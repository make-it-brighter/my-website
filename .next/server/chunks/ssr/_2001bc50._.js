...
;
const runtime = 'edge';
const alt = 'Rajpreet Singh - Law Student at SMU';
const size = {
    width: 1200,
    height: 630
};
...
async function __TURBOPACK__default__export__(props) {
    ...
    function getImageMetadata(imageMetadata, idParam) {
        const data = {
            ...
            url: imageUrl + (idParam ? '/' + idParam : '') + "?1fff685f00a4896e"
        };
...
//# sourceMappingURL=_2001bc50._.js.map